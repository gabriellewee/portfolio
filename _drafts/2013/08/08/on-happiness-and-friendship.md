...
<div class="photo-group photo-group-1-1-2">
	<figure>
		{% image './static/images/writing/2013-08-08-wip-1.jpg', 'Dragon digital sketch draft 1', 'horizontal', 'full', 'archive' %}
	</figure>
	<figure>
		{% image './static/images/writing/2013-08-08-wip-2.jpg', 'Dragon digital sketch draft 2', 'horizontal', 'full', 'archive' %}
	</figure>
	<figure>
		<figcaption>The swatches Ali gave us are so pretty *u*</figcaption>
		{% image './static/images/writing/2013-08-08-wip-3.png', 'Dragon digital sketch draft 3', 'horizontal', 'full', 'archive' %}
	</figure>
</div>
...
<div class="photo-group">
	<figure>
		...
		{% image './static/images/writing/2013-08-08-wacom-1.jpg', 'Photo of my Wacom tablet', 'horizontal', 'full', 'archive' %}
	</figure>
	<figure>
		<figcaption>A better photo I borrowed from Amazon's listing</figcaption>
		{% image './static/images/writing/2013-08-08-wacom-2.png', 'Amazon listing photo for Wacom tablet', 'horizontal', 'full', 'archive' %}
	</figure>
</div>
